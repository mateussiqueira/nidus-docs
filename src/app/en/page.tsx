    ...
    <div className="prose">
      ...
      <div style={{
        ...
        {[
          ...
          { label: "Deploy", value: "3.8s", sub: "Com cache" },
      ...
      <p>
        Nidus não é só um deployer. Ele é um <strong>edge proxy completo</strong> construído
      ...
      <p>
        Nidus está em alpha, mas o roadmap é ambicioso. A versão gratuita sempre terá o
        core completo. A versão paga (prevista para Q1 2027) adicionará:
        </p>
      <div style={{
      ...
      <p>
        Nidus foi otimizado para Mac (desenvolvimento local) e Linux (produção). No Mac,
        você pode rodar localmente para testar seus deploys antes de subir para produção.
...
# Pronto. Dashboard em http://meu-vps:3001`}
      ...
      <div style={{ textAlign: "center", marginTop: "3rem" }}>
        ...
        <p style={{ fontSize: "0.8rem", color: "var(--fg-muted)", marginTop: "0.75rem" }}>
          Free and open source. Runs on Mac, Linux, VPS. No vendor lock-in.
        </p>
      </div>
    </div>
  );
